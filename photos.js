...
function createEventListeners() {
  ...
  //the leftArrow() function will be executed when the user clicks the left navigation button
  
  leftarrow.addEventListener("click",leftArrow, false);
  
  //declare variable for document element with id of rightarrow in HTML document
